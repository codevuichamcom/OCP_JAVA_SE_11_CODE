...
public class Foo2 {
    public static void main(String[] args) {
        ...
        byte b5 = 'a';  // 97 in ASCII
        char c5 = 'a';
        double d5 = 'a';

        System.out.println("b5 = " + b5); // 97
        System.out.println("c5 = " + c5); // a
        System.out.println("d5 = " + d5); // 97.0

        byte b6 = '\u007F';
        char c6 = '\u007F'; // u is unicode, following it is hexadecimal
        ...
        //Underscore only to spit value , not split suffix or prefix
